...
var { getPedido, getPedidos, createPedido, getUsuarios, createUsuario, getProductos, createProducto, getMesas, createFactura, getClientes } = require('../controllers/restaurant.controllers');
